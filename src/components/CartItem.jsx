...
const CartItem = (props) => {
  ...
  return (
    <div className="flex shadow-lg shadow-black m-4 p-4 w-[90%] md:w-[40%] mx-auto rounded-2xl">
      ...
      <div className="flex flex-col gap-6 m-2">
        ...
        <div>
          <button
            className="border px-4 font-bold rounded "
          ...
          <input
            value={cartItems[id]}
            className="w-[100px] text-center border font-bold"
